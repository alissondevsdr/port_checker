...
export function getTemplate(mode = 'simples') {
...
export function detectColumnMapping(headers, mode = 'simples') {
...
//# sourceMappingURL=excelTemplate.js.map